...
# de datos PostgreSQL.
#
# Archivo Python: day_07_integrity_audit.py
#
# Archivo PNG: day_07_integrity_audit.png
# ==============================================================================
...
# ===========================================
# Obtiene de forma automática la ruta absoluta de la carpeta 'src' (ubicada un nivel arriba de este archivo).
src_dir = str(Path(__file__).resolve().parents[1])

# Verifica si 'src' ya está en la lista de carpetas donde Python busca módulos; si no, lo añade al inicio.
...
# ==============================================
# Importa la función 'get_secure_engine' desde tu módulo local para establecer conexiones seguras a bases de datos.
...
def execute_ingestion() -> bool:
    ...
    try:
        ...
        logging.info("✅ Ingesta relacional completada con éxito en PostgreSQL.")
