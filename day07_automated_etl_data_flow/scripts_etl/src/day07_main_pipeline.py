...
#
# Archivo Python: dat07_main_pipeline.py
#
# Archivo PNG: dat07_main_pipeline.png
# =============================================================================

# ==========================================
# --- BLOQUE 1: IMPORTACIÓN DE LIBRERÍAS ---
# ==========================================
import sys  # Importa funciones del sistema (lo usaremos para detener el programa de forma segura).
import time  # Importa herramientas de tiempo (útil si necesitas gestionar pausas o esperas).
import os  # Importa funciones para interactuar con tu sistema operativo (gestionar archivos).
from pathlib import (
    Path,
)  # Herramienta moderna para manejar rutas de carpetas y archivos.
...
# ===========================================
# Obtiene de forma automática la ruta absoluta de la carpeta 'src'.
# __file__ obtiene la ruta de este archivo, resolve() la vuelve absoluta, y parents[1] sube dos niveles en las carpetas.
src_dir = str(Path(__file__).resolve().parents[1])

# Verifica si la carpeta 'src' ya está registrada en el sistema de Python.
if src_dir not in sys.path:
    # Si 'src' no está registrada, la añade en la primera posición (índice 0) para que Python pueda encontrar y usar nuestros códigos personalizados.
...
from day07_automated_etl_data_flow.day07_integrity_audit import execute_ingestion


# ===================================================
# --- BLOQUE 6: PIPELINE PRINCIPAL DE INTEGRACIÓN ---
# ===================================================
def run_integrated_pipeline():
    ...
    try:
        ...
        logging.info("⚙️ Analizando consistencia cruzada en variables de nómina...")
